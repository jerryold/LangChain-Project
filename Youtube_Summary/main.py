...
import os
from youtubegpt import youtube_video_url_is_valid, find_insights

st.set_page_config(page_title="🎥 Youtube-Summary")
...
def yt_gpt_app():
    st.header(" 📹 YT-Summary : Get insights on youtube video")
